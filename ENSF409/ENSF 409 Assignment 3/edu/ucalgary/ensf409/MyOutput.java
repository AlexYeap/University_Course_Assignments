...
public class MyOutput {
	...
	public static String[] getSampleData() {
		...
		String[] dataLog = {
			...
			"Robot 227D - - [25/04/2022] \"FORWARD - NE (lidar)\""};
                return dataLog;
	}
	...
	public static String[] getBadData() {
		...
		String[] dataLog = {
			"Robot 890A - - [90/03/2022] \"START - NE (ultrasonic)\"",  //Contains invalid day and invalid sensor
			"Robot 890AZ - - [02/03/2022] \"BACKWARDS - N (infrared)\""};  //Contains invalid id and invalid movement
                return dataLog;
	}
